...
public class UploadFileUtils {
	...
	public static String uploadFile(String uploadPath, String originalName, byte[] filData) throws IOException {
		...
		FileCopyUtils.copy(filData, target);
	...
	public static String uploadFileNoThum(String uploadPath, String originalName, byte[] filData) throws IOException {
